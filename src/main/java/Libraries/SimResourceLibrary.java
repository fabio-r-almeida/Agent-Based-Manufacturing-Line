...
import Utilities.InspectionModel;
...
public class SimResourceLibrary implements IResource {
    ...
    Utilities.InspectionModel inspectionModel = new InspectionModel("model_loss=0.1029804398616155accuracy=0.975 (1).h5");
        ...
        if(skillID.equalsIgnoreCase(Constants.SK_QUALITY_CHECK)) {
            ...
            switch(this.myAgent.getLocalName()){
                ...
                case "QualityControlStation1":
                    ...
                    int result1 = inspectionModel.predict(inspectionModel.loadImage("QualityControlStation1.jpg",512,512,3));
                ...
                case "QualityControlStation2":
                    ...
                    int result2 = inspectionModel.predict(inspectionModel.loadImage("QualityControlStation2.jpg",512,512,3));
                    System.out.println("______________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________");
